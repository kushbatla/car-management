        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <input
              ...
              required
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gren-500 focus:border-green-500 outline-none transition-colors duration-200"
            />
          </div>

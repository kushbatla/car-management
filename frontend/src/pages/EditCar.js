...
const EditCar = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-950 py-8 px-4 sm:px-6 lg:px-8">
      
      <div className="max-w-3xl mx-auto">
      <div className="mb-6">
          <button
            onClick={() => navigate(`/cars/${id}`)}
            className="inline-flex items-center text-sm text-green-500 hover:text-green-700"
          >
                ...
                <div className="text-center">
                  ...
                  <div className="mt-2">
                    <label htmlFor="images" className="cursor-pointer">
                      <span className="text-green-600 hover:text-green-700">Upload new images</span>
